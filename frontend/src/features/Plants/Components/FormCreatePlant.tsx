...
export default function FormCreatePlant({
  setIsOpenModal,
  typeForm,
  setTypeForm,
  plantId,
}: FormCreatePlantProps) {
  ...
  return (
    <Box
      ...
      onSubmit={handleSubmit(
        typeForm === "update" ? SubmitUpdatePlant : SubmitCreatePlant,
        (errors) => {
        ...
        >
          ...
          >
            {unitMeasurementsData.map((unitMeasurement: UnitMeasurements) => (
              <MenuItem key={unitMeasurement.id} value={unitMeasurement.id}>
